...
import utils_img
import utils_model
from watermark_utils import decode_message_pil, decode_message, eval_message, msg2str, str2msg, load_model
...
def main(ldm_config: str = "/home/host_mueller/mueller/git/stable_signature/sd/stable-diffusion-2-1-base/v2-inference.yaml",
    ...
    for epoch in range(epochs):
        ...
        for batch in train_loader:
            ...
            # compute loss
            loss = nn.MSELoss()(imgs_d0, batch)  # I think this is used in stable diffusion AE training
            ...
            msg_extracted = decode_message(batch)
